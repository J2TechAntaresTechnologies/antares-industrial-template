...
```bash
git clone https://github.com/J2TechAntaresTechnologies/antares-industrial-template.git
cd antares-industrial-template
...
Consulta el diagrama de arquitectura en [`docs/arquitectura.md`](docs/arquitectura.md).
...
2. Ejecuta la app: `python run.py`
3. Accede al frontend en `http://localhost:5000`
4. Modifica rutas y scripts en la carpeta `app/` según tus necesidades.
...
3. Haz push a tu rama y crea un Pull Request.
4. Sigue la convención de commits y espera revisión antes de mergear.

---

## Documentación Adicional

- [Explicación técnica detallada](EXPLICACION_TECNICA.md)
- [Guía de integración GitHub, VS Code y Copilot](GITHUB_VSCODE_COPILOT.md)
...
- Juan Martinez (@jmartinez) - jmartinez@antarestechnologies.com
